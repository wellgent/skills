...
5. **Contract** - dev-loop declarations from orchestrate's `dev-loop-declarations.md` reference with the claimed ports; project `verify` skill from `verify-reference.md`.
